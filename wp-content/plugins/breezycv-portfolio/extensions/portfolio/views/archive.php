    ...
    <div class="single-page-content">
        <div class="content-wrapper">
			...
			<div class="page-title">
				<h1><?php esc_html_e( 'My Works', 'breezycv-portfolio' ); ?></h2>
			</div>
			...
			<div id="portfolio_content" class="portfolio-content" data-categories="<?php echo esc_attr($categories_selected_string); ?>">
				...
				<?php if ( ! empty( $categories ) ) : ?>
					<ul class="portfolio-filters">
						<li class="active">
							<a class="filter btn btn-sm btn-link" data-group="category_all"><?php esc_html_e( 'All', 'breezycv-portfolio' ); ?></a>
						</li>
								...
								<figure class="item <?php echo esc_attr($portfolio_type); ?>" data-groups='["category_all"<?php fw_theme_portfolio_post_taxonomies_slug(get_the_ID()); ?>]'>
									...
									<?php
										if ( has_post_thumbnail() ) {
											...
											?>
												<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio_no_image.jpg" class="portfolio-without-image" alt="<?php esc_attr_e('no image', 'breezycv-portfolio'); ?>" />
											<?php
									    }
									?>
