                ...
                if ( !empty($hp_buttons)) : ?>
                   <div class="home-buttons">
                    ...
                    foreach ($hp_buttons as $hp_buttons):
                        ...
                        $id = (!isset($hp_buttons['id'])) ? '' : $hp_buttons['id'];
                    ?>
                        <a href="<?php echo esc_url($hp_buttons['link']); ?>" target="<?php echo esc_attr($target) ?>" id="<?php echo esc_attr($id) ?>" class="btn btn-<?php echo esc_attr($type) ?>"><?php echo esc_attr($hp_buttons['title']); ?></a>
                    <?php endif;
                    endforeach;
                    ?>
                    </div>
