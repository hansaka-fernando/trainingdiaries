 ...
 */
add_filter( 'register_taxonomy_args', 'lmpixels_portfolio_taxonomy_gutenberg', 10, 2 );
 
function lmpixels_portfolio_taxonomy_gutenberg( $args, $taxonomy_name ) {
 
    if ( 'fw-portfolio-category' === $taxonomy_name ) {
        $args['show_in_rest'] = true;
        $args['rest_base']             = 'fw-portfolio-category';
