 ...
 */
function _action_theme_include_settings_export_option_types() {
    require_once dirname(__FILE__) . '/includes/option-types/settings-export/class-fw-option-type-settings-export.php';
}
add_action('fw_option_types_init', '_action_theme_include_settings_export_option_types');

function _action_theme_include_settings_import_option_types() {
    require_once dirname(__FILE__) . '/includes/option-types/settings-import/class-fw-option-type-settings-import.php';
}
add_action('fw_option_types_init', '_action_theme_include_settings_import_option_types');