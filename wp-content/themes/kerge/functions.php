	...
	function kerge_register_required_plugins() {
		tgmpa( array(
			array(
                ...
                'source'             => get_template_directory_uri() . '/admin/plugins/lmpixels-framework.zip', // The plugin source.
                'required'           => true,
                'version'            => '3.0.0',
            ),
            array(
            ...
            array(
                'name'               => 'Kerge Elementor', // The plugin name.
                'slug'               => 'kerge-elementor', // The plugin slug (typically the folder name).
                'source'             => get_template_directory_uri() . '/admin/plugins/kerge-elementor.zip', // The plugin source.
                'required'           => true,
                'version'            => '1.0.0',
            ),
			array(
